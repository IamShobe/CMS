...
if __name__ == '__main__':
    ...
    # conn.connect(port)
    #
    # conn.send_browse_msg(0x75, data="\x00")
    # conn.read_browsing_response()
    #
    # conn.send_browse_msg(0x71, data="\x00" + "\x00\x00\x00\x00" + "\x00\x00\x00\x04" + "\x00")
    # conn.read_browsing_response()
    #
    # conn.send_browse_msg(0x70, data="\x00\x02")
    # conn.read_browsing_response()
    #
    # conn.send_browse_msg(0x71,
    #                      data="\x01" + "\x00\x00\x00\x00" + "\x00\x00\x00\x04" + "\x00")
    # conn.read_browsing_response()
    #
    ...
    #
    #
    # conn.send_msg(0x74, data="\x03" + "\x00\x00\x00\x00\x00\x00\x00\x01" + "\x00\x02",
    ...
    #     s += ("%02x" % ord(b)) + " "
    # print s
    parse_avrcp('18\x11\x0e\tH\x00\x00\x19X`\x00\x00\x01\x04')
